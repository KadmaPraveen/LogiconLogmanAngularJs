app
    ...
    .controller('materialadminCtrl', function ($timeout, $state, $scope, growlService, UtilityFunc, $rootScope, Utility) {
       
        var userName = UtilityFunc.UserName();
        $scope.companyType = UtilityFunc.CompanyType();
        $scope.headerUrl = 'template/header.html?v=' + Utility.Version;
        $scope.sideMenuOtherUrl = 'template/sidebar-left.html?v=' + Utility.Version;
        $scope.sideMenuAdminUrl = 'template/sidebar-left-admin.html?v=' + Utility.Version;
        //growlService.growl('Welcome back ' + userName + '!', 'inverse')
        ...
        this.sidebarStat = function (event, state, title) {
            
            if (!angular.element(event.target).parent().hasClass('active')) {
                this.sidebarToggle.left = false;
            }

            $rootScope.$emit('NEW_TAB_REQUEST', {
                Title: title,
                State: state
            });
        }
        ...
        $scope.IsDefaultBranch = UtilityFunc.IsDefaultBranch();

    
    })


    .controller('SampleCntrl', ['$scope', '$state', '$stateParams', function ($scope, $state, $stateParams) {
    ...
    // Header
    // =========================================================================
    .controller('headerCtrl', ['$scope', '$timeout', 'messageService', '$location','UtilityFunc','Utility','mySharedService', function ($scope, $timeout, messageService, $location, UtilityFunc, Utility,mySharedService) {
