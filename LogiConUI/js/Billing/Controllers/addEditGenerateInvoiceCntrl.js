...
angular.module('LogiCon').controller('addEditCustomerInvoiceCntrl', ['$scope', '$uibModalInstance', 'ChargeCodeService', 'MerchantProfileService', 'limitToFilter', 'customerInvoiceItemObj', 'CustomerInvoiceService',
