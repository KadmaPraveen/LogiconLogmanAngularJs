angular.module('LogiCon').controller('CustomerCashBillInvoiceListCntrl', ['$scope', '$uibModal', 'CustomerInvoiceService', '$stateParams', 'DataTransferService', '$location', 'Utility', 'limitToFilter', '$http', 'UtilityFunc', '$state', 'NgTableParams', '$window', 'MerchantProfileService',
    function ($scope, $uibModal, CustomerInvoiceService, $stateParams, DataTransferService, $location, Utility, limitToFilter, $http, UtilityFunc, $state, NgTableParams, $window, MerchantProfileService) {
        ...
        $scope.BroadCastInvoice = function (obj) {
            debugger;
            $window.parent.MainModuleFunction(obj, 'customercashbilltype', 'customer Cash Bill');
        };
