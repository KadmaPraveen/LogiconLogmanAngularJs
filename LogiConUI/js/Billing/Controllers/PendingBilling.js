angular.module('LogiCon').controller('PendingBillingCntrl', ['$scope', 'PendingBillingService', 'CompanyService', 'limitToFilter', 'growlService', function ($scope, PendingBillingService, CompanyService, limitToFilter, growlService) {
