angular.module('LogiCon').controller('PaymentHistoryCntrl', ['$scope', 'PendingBillingService', 'CompanyService', 'limitToFilter', 'growlService', function ($scope, PendingBillingService, CompanyService, limitToFilter, growlService) {
