angular.module('LogiCon').controller('k1InquiryCntrl', ['$scope', 'k1Service', 'UtilityFunc', '$state', '$stateParams', 'NgTableParams', '$window',
    function ($scope, k1Service, UtilityFunc, $state, $stateParams, NgTableParams, $window) {
        ...
        $scope.ngTblData = new NgTableParams({
        ...
        },
            {
                ...
                getData: function ($defer, params) {
                    ...
                    k1Service.GetTableList(DataTblobj).then(function (res) {
    ...
    $scope.BroadCastDeclaration = function (obj) {
        $window.parent.MainModuleFunction(obj, 'k1declaration', 'k1 Declaration');
    };
