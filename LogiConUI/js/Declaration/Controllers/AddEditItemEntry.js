angular.module('LogiCon').controller('AddEditItemEntryCntrl', ['$scope', '$uibModalInstance', 'HSCodeService', 'ItemEntryService', 'limitToFilter', '$filter', 'dataObj', 'growlService', 'UtilityFunc','k1Service','$timeout',
    function ($scope, $uibModalInstance, HSCodeService, ItemEntryService, limitToFilter, $filter, dataObj, growlService, UtilityFunc, k1Service, $timeout) {
        ...
        $scope.declarationsubItems = new Array();
        ...
        $scope.subItems = $scope.ie.declarationsubItems;
        ...
        $scope.SaveItemEntry = function (ie) {            
            if ($scope.IsFrmItemEntryValid) {
                $scope.ie.declarationsubItems = new Array();
                angular.forEach($scope.subItems, function (item, val) {
                    $scope.ie.declarationsubItems.push({
                        ItemNo: val,
