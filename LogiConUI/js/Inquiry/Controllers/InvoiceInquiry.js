angular.module('LogiCon').controller('InvoiceInquiryCntrl', ['$scope', 'PendingBillingService', 'CompanyService', 'limitToFilter', 'growlService', function ($scope, PendingBillingService, CompanyService, limitToFilter, growlService) {
