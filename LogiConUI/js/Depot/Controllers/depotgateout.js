angular.module('LogiCon').controller('GateOutCntrl', ['$scope', 'DepotGateInService', 'UtilityFunc', 'Utility', 'MerchantProfileService', 'limitToFilter', 'DepotBookingService', 'OrderEntryService', 'VesselMasterService', 'growlService', 'CountryService','$window',
