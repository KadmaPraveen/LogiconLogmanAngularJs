angular.module('LogiCon').controller('GateInCntrl', ['$scope', 'GateInService', 'OrderEntryService', 'MerchantProfileService', 'limitToFilter', 'growlService', 'CountryService', 'BookingEntryService', 'VesselMasterService', '$window', 'UtilityFunc',
    function ($scope, GateInService, OrderEntryService, MerchantProfileService, limitToFilter, growlService, CountryService, BookingEntryService, VesselMasterService, $window, UtilityFunc) {
        ...
        $scope.onTimeSet = function (newDate, oldDate) {
            ...
            if (selectedDate > currentDate) {
                $window.alert('You cannot select future date');
                $scope.gi.TransactionDate = moment();
            }
        };
