...
angular.module('LogiCon').controller('AddEditContainerInfoCntrl', ['$scope', '$uibModalInstance', 'OrderEntryService', 'dataObj', 'growlService', 'UtilityFunc', function ($scope, $uibModalInstance, OrderEntryService, dataObj, growlService, UtilityFunc) {
    $scope.init = function () {
        $scope.dc = {
            BranchID: null,
            DeclarationNo: null,
