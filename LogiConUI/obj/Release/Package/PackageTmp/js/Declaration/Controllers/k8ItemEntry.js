angular.module('LogiCon').controller('k8ItemEntryCntrl', ['$scope',  '$uibModalInstance', 'ItemEntryService', 'limitToFilter', '$filter', 'growlService', 'UtilityFunc', 'k8Service', 'k1Service', 'HSCodeService', 'dataObj','$timeout',
    function ($scope, $uibModalInstance, ItemEntryService, limitToFilter, $filter, growlService, UtilityFunc, k8Service, k1Service, HSCodeService, dataObj, $timeout) {
