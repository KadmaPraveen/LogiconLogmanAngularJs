angular.module('LogiCon').controller('k2InquiryCntrl', ['$scope', 'k2Service', 'UtilityFunc', '$state', '$stateParams', 'NgTableParams','$window',
function ($scope, k2Service, UtilityFunc, $state, $stateParams, NgTableParams,$window) {
    $scope.i = {};    
        ...
        $scope.ngTblData = new NgTableParams({
        ...
        },
            {
                ...
                getData: function ($defer, params) {
                    ...
                    k2Service.GetTableList(DataTblobj).then(function (res) {
    ...
    $scope.BroadCastDeclaration = function (obj) {
        $window.parent.MainModuleFunction(obj, 'k2declaration', 'k2 Declaration');
    };
}]);