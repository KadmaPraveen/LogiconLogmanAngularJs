angular.module('LogiCon').controller('ContainerMasterCntrl', ['$scope', 'ContainerMasterService', 'OrderEntryService', 'MerchantProfileService', 'growlService', 'limitToFilter',
    function ($scope, ContainerMasterService, OrderEntryService, MerchantProfileService, growlService, limitToFilter) {
