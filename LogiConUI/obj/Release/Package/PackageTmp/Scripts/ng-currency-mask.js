(function() {
    angular.module('vtex.ngCurrencyMask', []).service('CurrencyMaskUtils', function ($filter) {
      ...
      CurrencyMaskUtils.toFloatString = function (value) {          
          if (value != null) {
            ...
            //    return elem[0].value = $filter('currency')(Utils.clearSeparators(value), '');
              //}
              //var te = $filter('currency')(CurrencyMaskUtils.clearSeparators(value), '');
              //
              return $filter('currency')(CurrencyMaskUtils.clearSeparators(value), '');
        }
      };
