...
(function ( angular ) {
    ...
    angular.module( 'treeControl', [] )
        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
             ...
             * @param addClassProperty - should we wrap the class name with 
             */
...
//                    return "" + $scope.orderBy;
                    ...
                    if(!template) {
                        template =
                            ...
                            'set-node-to-data>' +
                            '<i class="zmdi zmdi-plus p-5 f-14 " ng-class="iBranchClass()" ng-click="selectNodeHead(node)" ></i>' +
                            '<i class=" {{options.iLeafClass}}"></i>' +
